...
________________________________________________________________________________________________
				...
				----------------------------------------------------------
						...
						|___(_|/  \  |  |(_][ | ).__)(_.[  |[_) |
					 									   |
		 					 LuX AdminScript System v1.6 BETA
           	                    ---------------------------


//==============================================================================
--> Details/Questions/suggestions/Updates/Licenses:

FORUM-SAMP TOPIC: http://forum.sa-mp.com/index.php?topic=145919.0
*/
//==============================================================================
// Includes
//==============================================================================
...
dcmd_ahelp(playerid,params[])
{
	...
	{
		SendClientMessage(playerid, white, "___________ |- LuxAdmin System - Help -| ___________");
...
dcmd_observations(playerid,params[])
{
	...
	if(AccInfo[playerid][Level] > 0)
	{
		SendClientMessage(playerid, white, "___________ |- LuxAdmin System - Observations -| ___________");
...
dcmd_level(playerid,params[])
{
    if(AccInfo[playerid][Level] >= 1)
	{
		...
		if(AccInfo[playerid][Level] >= 1)
		{
		SendClientMessage(playerid, white, "___________ |- LuxAdmin - Basic Moderator (Level 1) -| ___________");
